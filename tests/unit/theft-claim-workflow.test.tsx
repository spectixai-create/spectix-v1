...
function claimList(): ClaimListResponse {
  return {
    items: [
      {
        ...
        slaLabel: 'תקין',
        handlingStatus: 'enhanced_review',
        handlingStatusLabel: 'בדיקה מוגברת',
        isStuck: false,
    ...
    summary: {
      ...
      investigation: 0,
      slaBreached: 0,
      averageHandlingDays: 1,
      averageTimeToInfoRequestDays: 1,
      claimsWithGaps: 1,
      claimsWithInconsistencies: 0,
      openClaimAmount: 2500,
      enhancedReviewAmount: 2500,
    },
  };
}
