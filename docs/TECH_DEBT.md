...
- [ ] 11l. `extracted_data` JSONB does not yet have a typed schema for the subtype block. After #03ד-1b extraction lands, harden via the existing discriminated union. **Owner:** CEO. **Trigger:** simultaneous with #03ד-1b PR.
